                            ...
                            {{#.}}
                                ...
                                {{^supported}}
                                    <div class="mck-form-text-wrapper">
                                        ...
                                        {{/number}}  
                                        {{^number}}
                                            <input type="{{type}}" placeholder="{{placeholder}}" name="{{label}}" class="{{datepicker_type}}" tabindex="3" min="{{min}}" max="{{max}}" data-hideweekend="{{hide_weekend}}" data-enable-mins="{{enable_mins}}" 
